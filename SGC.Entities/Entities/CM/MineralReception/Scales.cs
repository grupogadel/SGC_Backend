...
namespace SGC.Entities.Entities.CM.MineralReception
{
    public class Scales
    {
        ...
        public decimal Scale_TMH_Hist { get; set; }
        ...
        public string Scale_Conces_NO { get; set; }
        public string Scale_Conces_Name { get; set; }
        public string Scale_Commit_NO { get; set; }
        public string Creation_User { get; set; }
        public DateTime Creation_Date { get; set; }
        public string Modified_User { get; set; }
        public DateTime Modified_Date { get; set; }
        public string Scales_Status { get; set; }
        //public VendorOrigin VendorOrigin { get; set; }
